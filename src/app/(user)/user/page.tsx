      ...
      <div>
            ...
            <div className='col-span-12 text-center sm:text-start sm:col-span-6 lg:col-span-9 grid grid-cols-12 gap-x-21'>
                  ...
                  <p className='font-semibold'>
                     ...
                     {countDownEmail === 0 ? (
                        ...
                        <span className='inlineitems-block text-slate-400 font-normal text-sm'>
                           <FaCircleNotch size={14} className='-mt-1 animate-spin inline' />{' '}
                           {countDownEmail}
                        </span>
                     )}
                  </p>
               ...
               <div className='col-span-12 md:col-span-6 mb-3'>
                  ...
                  <div className='flex items-center gap-2 justify-center sm:justify-normal'>
                     {user?.balance >= 0 && (
                        <p className='text-green-500'>{formatPrice(user?.balance)}</p>
                     )}
                     <Link
         ...
         <div>
            <h3 className='text-2xl font-semibold mb-5'>
               Thông tin chi tiết{' '}
               <button
                  className={`text-sky-500 text-base font-normal group ${
                     isEditing ? 'text-slate-600' : ''
                  }`}
               ...
               <div className='col-span-1'>
                  {isEditing ? (
                     ...
                     <>
                        ...
                        <span className={!user?.firstname ? 'text-slate-400' : ''}>
                           {user?.firstname}
                        </span>
                     </>
                  )}
