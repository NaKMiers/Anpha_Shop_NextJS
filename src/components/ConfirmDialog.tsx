...
function ConfirmDialog({
  ...
  return (
    <div
      className='fixed z-30 top-0 left-0 h-screen text-dark w-screen hidden items-center justify-center p-21 bg-black bg-opacity-10 opacity-0 transition-all duration-300'
      ref={modalRef}>
      <div
