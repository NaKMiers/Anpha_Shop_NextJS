...
function AdminMeta({ handleFilter, handleResetFilter, className = '', children }: AdminMetaProps) {
  ...
  return (
    <div
      className={`no-scrollbar mt-8 w-full max-w-full self-end overflow-auto rounded-medium bg-white p-21 text-dark shadow-md transition-all duration-300 ${className}`}
    >
